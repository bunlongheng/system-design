...
export default async function generate(req, res) {
  ...
  const { rows } = await db.query(
    "INSERT INTO system_designs (user_id, title, slug, nodes, edges, type, tags, tokens_out) VALUES ($1, $2, $3, $4::jsonb, $5::jsonb, $6, $7::text[], $8) RETURNING id",
    [owner, title.trim(), slug, JSON.stringify(nodes), JSON.stringify(edges), "system-design", ["AI"], tokensOut],
  );

...
export const SERVICES = {
  ...
  microservices:{ label: 'Microservices',     sub: 'Business Logic',      color: '#6366f1', icon: '/icons/gen-microservices.svg' },
  service:      { label: 'Service',           sub: 'Microservice',        color: '#6366f1', icon: '/icons/gen-service.svg' },
